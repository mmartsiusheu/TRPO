...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			 ...
			 */
			me.chart = me;
			me.controller = me; // chart.chart.rest_app #inception
			...
			if (!context || !canvas) {
				...
				// the chart initialization but after setting basic chart / rest_app properties that
 ...
 * since responsiveness is handled by the rest_app.resize() method. The config is used
...
defaults._set('global', {
	legend: {
		...
		onClick: function(e, legendItem) {
			...
			// See rest_app.isDatasetVisible comment
